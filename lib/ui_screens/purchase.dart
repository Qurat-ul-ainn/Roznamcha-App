                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                            "123,456.00",
                            style: TextStyle(color: AppColors.kSimpleBtnClr),
                          ),
                        ],
                      ),
                    ),
                            ...
                            children: [
                              CustomGradientButton(
                                ...
                                btnClr:  LinearGradient(
                                  colors: <Color>[ AppColors.kSimpleBtnClr,  AppColors.kSimpleBtnClr],
                                ),
                              ),
                              Text(
                                "Rs. 4,32,000",
                                style: TextStyle(
                                    color: AppColors.kSimpleBtnClr, fontSize: 18.0),
                              ),
                            ],
                          ),
                        ],
...
class ListViewComponentA extends StatelessWidget {
  ...
  const ListViewComponentA({Key key, this.price, this.btnFunction})
      : super(key: key);
